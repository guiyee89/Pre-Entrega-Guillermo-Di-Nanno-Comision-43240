    ...
    <>
      <Wrapper>
        <Wrapper2>
          ...
          <CountButton onClick={increment} disabled={count >= stock}>+</CountButton>
          <ResetButton onClick={reset}>Reset</ResetButton>
        </Wrapper2>
        <AddCartButton onClick={()=>onAdd(count)} disabled={stock === 0 || count >= stock}>Add to Cart</AddCartButton>
      </Wrapper>
    </>
  );
};
